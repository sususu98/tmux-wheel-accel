...
| 滚动状态 | 触发时间差 ($\Delta t$) | 单次跳行步长 | 适用场景 |
| :--- | :--- | :--- | :--- |
| **单格刻度 / 逐行精读** | $\ge 130\text{ms}$ | **1 行** | 精准核对代码、查看单行日志 |
| **慢速连续滚动** | $70\text{ms} \sim 130\text{ms}$ | **2 行** | 逐段阅读 |
| **中速翻阅** | $35\text{ms} \sim 70\text{ms}$ | **3 ~ 6 行** | 正常滑屏浏览 |
| **快速拨轮** | $18\text{ms} \sim 35\text{ms}$ | **8 ~ 20 行** | 快速跨段落查找 |
| **G502 无极飞轮 / 疾速狂转** | $< 18\text{ms}$ (高频) | **16 ~ 46 行** | 疾速跳跃几千行历史回滚 |
