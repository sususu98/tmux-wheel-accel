...
| 滚动状态 | 触发时间差 ($\Delta t$) | 单次跳行步长 | 体验与场景 |
| :--- | :--- | :--- | :--- |
| **单格刻度 / 逐行精读** | $\ge 60\text{ms}$ | **1 行** | 精准核对单行代码、无误跳 |
| **正常中速 / 触控板连续滑动** | $25\text{ms} \sim 60\text{ms}$ | **1 ~ 2 行** | 平稳可控、不冲、不飞顶 |
| **较快拨动** | $12\text{ms} \sim 25\text{ms}$ | **2 ~ 4 行** | 快速看代码 |
| **快速用力拨轮** | $6\text{ms} \sim 12\text{ms}$ | **4 ~ 8 行** | 快速翻页 |
| **G502 无极飞轮 / 超高频狂转** | $< 6\text{ms}$ (超高频) | **8 ~ 18 行** | 无极飞轮疾速翻越几千行历史 |
