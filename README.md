...
| 2 档 | 触摸板手势 / 慢速连续巡航 | $12\text{ms} \sim 45\text{ms}$ | 任意 | 1 行 | 触控板双指滑动细腻、平缓可控 |
| 3 档 | 较快翻阅代码 | $7\text{ms} \sim 12\text{ms}$ | $\ge 4$ | 2 行 | 轻松翻阅 |
| 4 档 | 快速连续拨轮 | $4.5\text{ms} \sim 7\text{ms}$ | $\ge 4$ | 4 行 | 快速看长函数 |
| 5 档 | G502 无极飞轮中高速 | $3.5\text{ms} \sim 4.5\text{ms}$ | $\ge 25$ (长旋飞轮) | 8 行 | 飞速滑过几百行 |
| 6 档 | G502 物理飞轮红线狂转 | $< 3.5\text{ms}$ (超高频) | $\ge 25$ (长旋飞轮) | 16 行 | 真正 6 档红线起飞，瞬间翻越长日志 |
